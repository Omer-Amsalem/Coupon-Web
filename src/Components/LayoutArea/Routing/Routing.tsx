...
import CouponListByCategory from "../../MainArea/Company/CouponListByCategory/CouponListByCategory";
import CouponListByMaxPrice from "../../MainArea/Company/CouponListByMaxPrice/CouponListByMaxPrice";
    ...
    return (
      <div className="Routing">
        <Switch>
          ...
          <Route path="/getCompanyCouponsByCategory" component={CouponListByCategory}/>
          <Route path="/getCouponsByMaxPrice" component={CouponListByMaxPrice}/>
